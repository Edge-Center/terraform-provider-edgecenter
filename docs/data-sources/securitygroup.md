...
- `id` (String) The ID of the security group. Either 'id' or 'name' must be specified.
...
- `name` (String) The name of the security group. Either 'id' or 'name' must be specified.
