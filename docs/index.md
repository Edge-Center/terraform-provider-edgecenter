...
- `edgecenter_rmon_api` (String) RMON API
...
if that fails does it fall back to the Terraform registry, and after that to
the public Yandex Cloud terraform mirror. The answer, including a failure, is
