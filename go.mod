...
require (
	...
	github.com/Edge-Center/edgecentercdn-go v0.1.19
	...
	github.com/phkrl/edgecenterprotection-go v0.1.4
...
replace github.com/phkrl/edgecenterprotection-go => git.local.org/go/edgecenterprotection-go v0.1.4
